...
function toggleCardSearch() {
  if (!document.getElementById("cardSearchOverlay")) {
    ...
    let selectTagSize = _isMobile ? "font-size:4vw;" : "";
    div.innerHTML = `
    <div style="height:100vh;display:flex;flex-direction:column;justify-content:center;">
      <div id="cardSearchWindow" style="width:80vw;height:80vh;padding:1vw;background-color:#000000;">
        <div class="flexdivc">
          ...
          <select id="cardSearchFormat" style="margin-left:1vw;${selectTagSize}" onchange="cardSearch(document.getElementById('cardSearchInput').value)">
          ...
          <select id="cardSearchReleased" style="margin-left:1vw;${selectTagSize}" onchange="cardSearch(document.getElementById('cardSearchInput').value)">
          ...
          <select id="cardSearchSort" style="margin-left:1vw;${selectTagSize}" onchange="cardSearch(document.getElementById('cardSearchInput').value)">
  ...
  setTimeout(() => {
    if (document.getElementById("cardSearchInput").value == txt) {
      ...
      for (let item of filteredCards) {
        ...
        innerHTML += `<img src="https://images.ygoprodeck.com/images/cards/${
          item.konamiID
