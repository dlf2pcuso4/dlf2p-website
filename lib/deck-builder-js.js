var jsonDataDl, cardData, cardQuery, imgCount, imgLoadedCount, cardSelected;
var cardSize = 0.3;
var imgPerRow = 6;
var deckArray = [];
var deckIndex = 0;
...
function searchCard() {
  if (btnSearch.innerHTML == "Search") {
    ...
    cnvResults.height =
      (614 * cardSize + 30) * Math.ceil(cardData.length / imgPerRow);
...
function sendDeck() {
  ...
  window.location.href = "deck-display.html?deckcode=" + encodeDeck(deckcode);
}
