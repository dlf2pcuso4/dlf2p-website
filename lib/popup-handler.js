...
if (_popup) {
  ...
  _popup.style.cssText =
    "position: fixed; width: 100%; height: 100%; inset: 0px; background-color: #000000C0; z-index: 2; cursor: pointer;";
...
const showPopup = () => {
  ...
  _popupwindow.style.marginLeft =
    50 - (_popupwindow.offsetWidth * 50) / window.innerWidth + "%";
  _popupwindow.style.marginTop =
    25 - (_popupwindow.offsetHeight * 25) / window.innerHeight + "%";
};
